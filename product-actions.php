...
<?php 
    ...
    if (isset($_POST["product_name"])){
        ...
        $stm = $db_con->prepare("SELECT Product.product_id, Product.product_name, PType.p_type_name, unit.unit_name
                                ...
                                <table style = "width:100%"  class="table"> <!-- ตาราง -->
                                    ...
                                    <thead class="thead-dark">
                                        <tr align="center" >    <!-- แถว -->
                                            ...
                                            <th width="100px" style="color:rgb(255, 255, 255)"><B>แก้ไข</th>
                                            <th width="100px" style="color:rgb(255, 255, 255)"><B>ลบ</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr style="color:rgb(255, 255, 255)" >
                                            ...
                                            <td > <center> <a href="product-edit.php">แก้ไข</a>      </center></td>
                                            <td > <center> <a href="actions.php?do=delete&id=<?php echo $rows['product_id'];?>">ลบ</a>      </center></td>
                                        </tr>
